...
#args = parser.parse_args("--num_hidden=5 --hidden_size=70 --pred_seq_len=50 --loss= MSE --weight_decay=0 --dropout=0.005 --rnn_type=GRU --case=1".split())
...
outfolder = 'final_net'
outfile = f'rnn_{"_".join(sys.argv[1:]).replace("=","_")}.pkl'.lower()
